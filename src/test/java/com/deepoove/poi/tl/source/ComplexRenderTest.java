        ...
        Map<String, Object> datas = new HashMap<String, Object>() {
            {
                ...
                put("treadPicture", new PictureRenderData(220, 135, ".png", BytePictureUtils.getLocalByteArray(new File("src/test/resources/logo.png"))));
                ...
                String code = "detect_";
                for (int i = 0; i < 25; i++) {
                    put(code + i + "pic", new PictureRenderData(8, 8, "src/test/resources/0-1.png"));
